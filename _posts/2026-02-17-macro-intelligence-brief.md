---
layout: post
title: "Macro Intelligence Brief — February 17, 2026"
date: 2026-02-17
---
...
1. **Long NEM / Short CRM** — Core position, both legs strengthening. Gold above $5,100 vs. 20% software selloff.
2. **Long CEG / Short FSLR** — Nuclear vs. solar divergence widening with every policy data point.
3. **Long NVDA / Short ACN** — AI infrastructure vs. AI-disrupted services. Sentiment-driven NVDA decline improves entry.
4. **Long CRWD / Short PAYC** — Cybersecurity (AI-enhanced) vs. HR software (AI-disrupted). The decoupling trade.
5. **Long ETN / Short AES** — Grid infrastructure (bipartisan, secular) vs. US renewables (policy headwind).
6. **Long COIN / Short GDDY** — NEW. Crypto regulatory tailwind + stealth QE vs. AI-disrupted web services.
7. **Long MPC / Short DVN** — Refiner margin vs. producer margin in sub-$60 oil.
