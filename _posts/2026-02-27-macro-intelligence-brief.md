...
1. **DHI EXIT: PPI 0.8% hot print triggers accumulated exit condition.** Five negative data points now exceed three positive. Rotating to ACGL ($900 allocation).

2. **CoreWeave revenue miss contradicts NVDA-resolves-everything narrative.** Blue Owl stress unresolved. Credit cascade probability up to 22-27%. APO thesis strengthened.

3. **Seven institutional credit warnings (BofA added).** Credit warning density unprecedented. APO + ICE/CBOE remain best positioned.

4. **M&A at maximum breadth — seven deals in six sectors in five days.** JPM IB thesis at strongest evidence point in series.

5. **SEBI gold authorization = 11th structural NEM driver.** $384B Indian equity funds authorized for 35% gold/silver allocation.

6. **PYPL acquisition thesis downgraded.** Stripe explicitly denied takeover talks — contradicts two-source confirmed thesis from prior briefs.

7. **Zscaler miss raises first challenge to broad cybersecurity bullishness.** CRWD differentiated but sector headwinds emerging. Maintaining position but no longer maximum evidence strength.

8. **Software rotation underway (Risk #1 crystallizing at 35%).** NOW/CRM pair trade faces temporary pressure. Thesis intact but timing risk elevated.
